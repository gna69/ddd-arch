...
import (
	...
	"ddd-arch/internal/domain/customer/memory"
	"ddd-arch/internal/domain/customer/mongo"
	"ddd-arch/internal/domain/product"
	prodmemory "ddd-arch/internal/domain/product/memory"
...
func (o *OrderService) CreateOrder(customerID uuid.UUID, productIDs []uuid.UUID) (float64, error) {
	...
	log.Printf("Customer: %s has ordered %d products", c.ID(), len(products))
